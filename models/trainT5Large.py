...
class T5Trainer:
    ...
    def preprocess_function(self, examples):
        ...
        labels = self.tokenizer(text_target=examples["summary"], max_length=256, truncation=True, padding=True)
    ...
    def train(self):
        ...
        self.model.save_pretrained("./trained_t5_large")
        self.tokenizer.save_pretrained("./trained_t5_large")
